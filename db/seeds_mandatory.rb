...
board = BbsBoard.create(name: '吞食天地2ND', description: '吞食天地2ND')
...
board = BbsBoard.create(name: '吞食家族', description: '吞食家族')
...
board = BbsBoard.create(name: '周边相关', description: '周边相关')
...
board = BbsBoard.create(name: '站务', description: '站务')
board.children.create(
  name: '版务专区',
  logo: '/assets/examples/02.jpg',
  description: '版务专区'
